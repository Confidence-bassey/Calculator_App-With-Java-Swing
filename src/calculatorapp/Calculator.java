...
public class Calculator extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        int txtLength = jTextField1.getText().length();
        int number = jTextField1.getText().length()-1;
        String storeCurrentValue;
        
        if(txtLength >0){
            StringBuilder delback = new StringBuilder(jTextField1.getText());
            delback.deleteCharAt(number);
            storeCurrentValue = delback.toString();
            jTextField1.setText(storeCurrentValue);
        }
